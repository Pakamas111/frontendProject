...
export default function DataUserAdmin() {
  ...
  const [itemsDataAd, setItemsDataAd] = React.useState([]);
    ...
    },
    {
      ...
      renderCell: (params) => (
        <ButtonGroup>
          ...
          <Button onClick={() => Userdel(params.row.user_id, true)}>ลบ</Button>
        </ButtonGroup>
      ),
    },
  ];
      ...
      <Container
        ...
        <Paper sx={{ marginTop: '60px', width: 1250 }}>
          <Box sx={{ p: 3 }}>
            ...
            <div style={{ height: 400, width: '100%',alignItems: 'center',justifyContent: 'center' }}>
              <DataGrid
                rows={itemsDataAd}
